...
namespace Task_Management.CustomControls
{
    class CustomComboBox : UserControl
    {
        ...
        private void ComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            // Refresh text
            lblText.Text = cmbList.SelectedIndex > 0 ? cmbList.Text : PlaceholderText;
        }
        ...
        public void LoadItems(DataTable dataTable, string displayMember, string valueMember)
        {
            cmbList.Items.Clear();
            cmbList.DataSource = dataTable;
            cmbList.DisplayMember = displayMember;
            cmbList.ValueMember = valueMember;

           

            // Set the default text to placeholder
            cmbList.SelectedIndex = 0; // Default to the placeholder
        ...
        public object SelectedValue
        {
            get
            {
                return cmbList.SelectedIndex == 0 ? -1 : cmbList.SelectedValue;
            }
            set
            {
